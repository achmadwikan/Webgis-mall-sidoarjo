...
<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title mb-0">Data Kelurahan</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0">Detail Data Kelurahan</h5>
           ...
           success:function(html){
            ...
            $('#zoom').on('click', function() {
                ...
                var latlng = new L.LatLng(latval, lngval);
                   ...
                   mymap = L.map('mapid3').setView(latlng, 15)
                  ...
                  var marker = L.circle(latlng, 100).setStyle({ 
                                    color: "red"
                                }).addTo(mymap);
             });
