    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                {!! Form::select('role_id', ['1' => 'Admin', '2' => 'Member'], $data->role_id, ['placeholder' => 'Pilih role pengguna...', 'class' => 'form-control', 'required', 'oninvalid' => "this.setCustomValidity('Mohon diisi dengan lengkap')", 'oninput' => "this.setCustomValidity('')"]); !!}
            </div>
            <hr>
        </div>
