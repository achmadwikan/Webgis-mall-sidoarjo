        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('auth.regis') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <label for="jenis" class="col-md-4 control-label">Jenis Pendaftaran</label>

                            <div class="col-md-6">
                                <select class="form-control" name="jenis">
                                  <option value="1" selected>Individu</option>
